...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="z-10 flex flex-col items-center justify-center w-full max-w-4xl px-4 mt-[-10vh]">
        <h1 className="text-4xl md:text-5xl font-extrabold text-hpBlue tracking-[0.3em] uppercase mb-[-1rem] z-20">
          Hotel
        </h1>
        <img 
          src="/assets/Pavillon_neonSchriftzug_4.gif" 
          alt="Hotel Pavillon Neon" 
          className="w-full max-w-2xl md:max-w-4xl object-contain drop-shadow-2xl z-10" 
        />
      </div>

      <div className="absolute bottom-24 w-full flex flex-col items-center justify-center text-center px-4 z-20">
        <h3 className="text-lg md:text-xl font-light tracking-widest text-[#f9e0d8] uppercase mb-4">
          Das Shared Office das <del className="opacity-60 mx-1 border-[#f9e0d8]">dich</del> du brauchst
        </h3>
